...
wget -q https://github.com/la5nta/pat/releases/download/v0.18.0/pat_0.18.0_linux_amd64.deb
dpkg -i pat*.deb
apt-get update
...
echo 'TNC_INIT_CMD="/usr/bin/tmd710_tncsetup -B 0 -S $DEV -b $HBAUD"' >>/etc/default/ax25
